...
NAME="fluxy"                                      # Name of the application
DJANGODIR=/home/deploy/fluxy                      # Django project directory
...
DJANGO_SETTINGS_MODULE=fluxy.settings             # which settings file should Django use
